<?php
/* Smarty version 5.4.1, created on 2024-10-15 19:07:01
  from 'file:_footer.bottom_bar.tpl' */

/* @var \Smarty\Template $_smarty_tpl */
if ($_smarty_tpl->getCompiled()->isFresh($_smarty_tpl, array (
  'version' => '5.4.1',
  'unifunc' => 'content_670ebd550206a4_42321953',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'fc8110be365109b61025a270d778848b798da4f8' => 
    array (
...
function content_670ebd550206a4_42321953 (\Smarty\Template $_smarty_tpl) {
...
$_smarty_tpl->renderSubTemplate('file:__svg_icons.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array('icon'=>"reels",'class'=>"header-icon ".$_prefixVariable1,'width'=>"32px",'height'=>"32px"), (int) 0, $_smarty_current_dir);
?>
...
$_smarty_tpl->renderSubTemplate('file:__svg_icons.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array('icon'=>"watch",'class'=>"header-icon ".$_prefixVariable2,'width'=>"32px",'height'=>"32px"), (int) 0, $_smarty_current_dir);
?>
...
$_smarty_tpl->renderSubTemplate('file:__svg_icons.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array('icon'=>"header-home",'class'=>"header-icon ".$_prefixVariable3,'width'=>"32px",'height'=>"32px"), (int) 0, $_smarty_current_dir);
?>
      ...
      <?php if ($_smarty_tpl->getValue('user')->_data['can_publish_posts'] || $_smarty_tpl->getValue('user')->_data['can_go_live'] || $_smarty_tpl->getValue('user')->_data['can_add_stories'] || $_smarty_tpl->getValue('user')->_data['can_write_blogs'] || $_smarty_tpl->getValue('user')->_data['can_sell_products'] || $_smarty_tpl->getValue('user')->_data['can_raise_funding'] || $_smarty_tpl->getValue('user')->_data['can_create_ads'] || $_smarty_tpl->getValue('user')->_data['can_create_pages'] || $_smarty_tpl->getValue('user')->_data['can_create_groups'] || $_smarty_tpl->getValue('user')->_data['can_create_events']) {?>
        <div class="link">
          <a class="dropdown" href="#" data-bs-toggle="dropdown" data-display="static">
            <?php $_smarty_tpl->renderSubTemplate('file:__svg_icons.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array('icon'=>"header-plus",'class'=>"header-icon",'width'=>"32px",'height'=>"32px"), (int) 0, $_smarty_current_dir);
?>
...
$_smarty_tpl->renderSubTemplate('file:__svg_icons.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array('icon'=>"header-search",'class'=>"header-icon ".$_prefixVariable4,'width'=>"32px",'height'=>"32px"), (int) 0, $_smarty_current_dir);
?>
