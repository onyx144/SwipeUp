<?php
/* Smarty version 5.4.1, created on 2024-10-15 20:02:09
  from 'file:_header.tpl' */

/* @var \Smarty\Template $_smarty_tpl */
if ($_smarty_tpl->getCompiled()->isFresh($_smarty_tpl, array (
  'version' => '5.4.1',
  'unifunc' => 'content_670eca41829d27_15119504',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '2278e2bdde444f65db58a1bc731efecbaac9c7d1' => 
    array (
      0 => '_header.tpl',
      1 => 1729022526,
      2 => 'file',
...
function content_670eca41829d27_15119504 (\Smarty\Template $_smarty_tpl) {
...
" class="<?php if ($_smarty_tpl->getValue('system')['theme_mode_night']) {?>night-mode<?php }?> <?php if (!$_smarty_tpl->getValue('system')['chat_enabled']) {?>n_chat<?php }
...
) fixed !important; background-size: 100% auto;" <?php }?> <?php if ($_smarty_tpl->getValue('page') == "share" && $_smarty_tpl->getValue('url')) {?>onload="initialize_scraper()" <?php }?>>    
	<?php }?>
    <!-- main wrapper -->
...
"><?php echo $_smarty_tpl->getValue('user')->_data['name'];?>
      ...
      <?php if ($_smarty_tpl->getValue('page') != "index" || ($_smarty_tpl->getValue('user')->_logged_in || $_smarty_tpl->getValue('system')['newsfeed_public'])) {?>
        <div class="main-header<?php if ($_smarty_tpl->getValue('page') == 'reels') {?>x-hidden<?php }?>" <?php if ($_smarty_tpl->getValue('system')['fluid_design']) {?>style="padding-right: 0;" <?php }?>>
          <div class="<?php if ($_smarty_tpl->getValue('system')['fluid_design']) {?>container-fluid<?php } else { ?>container<?php }?>">
            <div class="row">
