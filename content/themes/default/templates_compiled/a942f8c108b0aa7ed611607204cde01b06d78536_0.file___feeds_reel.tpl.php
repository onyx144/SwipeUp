<?php
/* Smarty version 5.4.1, created on 2024-10-18 12:19:21
  from 'file:__feeds_reel.tpl' */

/* @var \Smarty\Template $_smarty_tpl */
if ($_smarty_tpl->getCompiled()->isFresh($_smarty_tpl, array (
  'version' => '5.4.1',
  'unifunc' => 'content_67125249b75126_86619867',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'a942f8c108b0aa7ed611607204cde01b06d78536' => 
    array (
      0 => '__feeds_reel.tpl',
      1 => 1729253950,
      2 => 'file',
...
function content_67125249b75126_86619867 (\Smarty\Template $_smarty_tpl) {
...
" type="video/mp4" size="2160">
        ...
        <div class="post_author_name_conteiner">
          <!-- post author -->
          <?php if ($_smarty_tpl->getValue('post')['is_anonymous']) {?>
            <span class="post-author-mod"><?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Anonymous");?>
</span>
          <?php } else { ?>
...
">
              <a class="post-author-mod" href="<?php echo $_smarty_tpl->getValue('post')['post_author_url'];?>
                ...
                <div class="reaction-btn">
                  <?php if (!$_smarty_tpl->getValue('post')['i_react']) {?>
                    <div class="reaction-btn-icon">
                      <i class="far fa-smile fa-fw white-icon smile-mod" style="color: white;"></i>
                    </div>
                  <?php } else { ?>
                    <div class="reaction-btn-icon">
